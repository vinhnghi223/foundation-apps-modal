...
angular.module('myModal', ['foundation'])
    ...
    .factory('modalService', function(FoundationApi, $controller, $rootScope, $http, $q, $compile, $timeout, $window, $templateCache) {
        ...
        function createModal(config) {
            ...
            if(config.templateUrl) {
                ...
                throw new Error('modal: template should be defined');
            }
